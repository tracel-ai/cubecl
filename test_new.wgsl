...
fn main(
    ...
    if l_0_5 {
        ...
        l_0_10 = input_0_global[l_0_6];
        l_0_9[3u] = f32(l_0_10);
        shared_memory_0[l_0_8] = vec4<f32>(l_0_9);
        l_0_6 = 1u * l_0_2;
        l_0_11 = l_0_0 + l_0_6;
        l_0_11 = l_0_11 / 1u;
        l_0_6 = 1u * 8u;
        ...
        l_0_13[0u] = f32(l_0_10);
        l_0_8 = l_0_7 + 1u;
        l_0_10 = input_0_global[l_0_8];
        l_0_13[1u] = f32(l_0_10);
        l_0_8 = l_0_7 + 2u;
        l_0_10 = input_0_global[l_0_8];
        l_0_13[2u] = f32(l_0_10);
        l_0_8 = l_0_7 + 3u;
        l_0_10 = input_0_global[l_0_8];
        l_0_13[3u] = f32(l_0_10);
        shared_memory_0[l_0_12] = vec4<f32>(l_0_13);
        l_0_8 = 2u * l_0_2;
        l_0_6 = l_0_0 + l_0_8;
        l_0_8 = l_0_6 / 1u;
        l_0_11 = 2u * 8u;
        ...
        l_0_10 = input_0_global[l_0_12];
        l_0_9[3u] = f32(l_0_10);
        shared_memory_0[l_0_11] = vec4<f32>(l_0_9);
        l_0_12 = 3u * l_0_2;
        l_0_6 = l_0_0 + l_0_12;
        l_0_12 = l_0_6 / 1u;
        l_0_8 = 3u * 8u;
        ...
        l_0_10 = input_0_global[l_0_11];
        l_0_13[3u] = f32(l_0_10);
        shared_memory_0[l_0_8] = vec4<f32>(l_0_13);
    }
