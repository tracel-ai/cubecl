...
pub struct WgpuStorage {
    memory: HashMap<StorageId, Pdrc<wgpu::Buffer>>,
...
impl WgpuStorage {
    ...
    pub fn new(device: Pdrc<wgpu::Device>) -> Self {
        Self {
            memory: HashMap::new(),
...
impl ComputeStorage for WgpuStorage {
    ...
    fn alloc(&mut self, size: u64) -> StorageHandle {
        ...
        let buffer = Pdrc::new(self.device.create_buffer(&wgpu::BufferDescriptor {
            label: None,
            size,
