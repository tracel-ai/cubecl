...
> StageMatmulFamily for UnitMatmulFamily<TM, StageIn, StageAcc>
{
    ...
    fn setup<R: Runtime>(
        ...
        let lhs_smem_config = StageMemoryConfig {
            ...
            elements_per_tile_along_row: selection.tiling_scheme.elements_in_tile_m(),
            elements_per_tile_along_col: selection.tiling_scheme.elements_in_tile_k(),
            tiles_per_partition_along_row: selection.tiling_scheme.tiles_in_stage_partition_m(),
            tiles_per_partition_along_col: selection.tiling_scheme.tiles_in_stage_partition_k(),
            partitions_per_stage_along_row: selection.tiling_scheme.stage_partitions_in_stage_m(),
            partitions_per_stage_along_col: selection.tiling_scheme.stage_partitions_in_stage_k(),
        ...
        let rhs_smem_config = StageMemoryConfig {
            ...
            elements_per_tile_along_row: selection.tiling_scheme.elements_in_tile_k(),
            elements_per_tile_along_col: selection.tiling_scheme.elements_in_tile_n(),
            tiles_per_partition_along_row: selection.tiling_scheme.tiles_in_stage_partition_k(),
            tiles_per_partition_along_col: selection.tiling_scheme.tiles_in_stage_partition_n(),
            partitions_per_stage_along_row: selection.tiling_scheme.stage_partitions_in_stage_k(),
            partitions_per_stage_along_col: selection.tiling_scheme.stage_partitions_in_stage_n(),
