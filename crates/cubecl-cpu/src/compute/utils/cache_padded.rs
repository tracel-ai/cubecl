/// This file was taken from crossbeam as I didn't need anything else: https://github.com/crossbeam-rs/crossbeam/blob/main/crossbeam-utils/src/cache_padded.rs
use core::{
    fmt,
    ops::{Deref, DerefMut},
};
