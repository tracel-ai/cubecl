...
impl<D: Dialect> Display for Variable<D> {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Variable::ClusterRank => f.write_str("cluster.block_rank()"),
            Variable::ClusterIndexX => f.write_str("cluster.block_index().x"),
            Variable::ClusterIndexY => f.write_str("cluster.block_index().y"),
            Variable::ClusterIndexZ => f.write_str("cluster.block_index().z"),
