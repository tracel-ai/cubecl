...
nonuniform_unary_plane_op!("plane.inclusive_i_sum", InclusiveISumOp);
nonuniform_unary_plane_op!("plane.inclusive_f_sum", InclusiveFSumOp);
nonuniform_unary_plane_op!("plane.exclusive_i_sum", ExclusiveISumOp);
nonuniform_unary_plane_op!("plane.exclusive_f_sum", ExclusiveFSumOp);
