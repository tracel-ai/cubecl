use cubecl_core::{Runtime, client::ComputeClient, prelude::TensorArg};
...
pub fn launch_conv2d_nhwc<R: Runtime, MP: MatmulPrecision, Alg: Algorithm, S: ConvSelector<Alg>>(
    ...
    let (selection, config_input) = S::select_kernel::<R, MP>(client, &problem, plane_dim);
    ...
    unsafe {
        Alg::GlobalConvolution::launch_unchecked::<MP, R>(
