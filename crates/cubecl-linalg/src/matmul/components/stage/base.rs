...
use super::{StageEventListener, TilingLayout, staging::StageReader};
    ...
    MatmulConfigFactory<Config: StageConfig> + Send + Sync + 'static
{
    ...
    type Matmul<MP: MatmulPrecision, TL: TilingLayout, TR: TilingLayout>: StageMatmul<MP, TL, TR, Config = Self::Config>;
}
...
pub trait StageMatmul<MP: MatmulPrecision, TL: TilingLayout, TR: TilingLayout>:
    'static + Send + Sync
{
    ...
    fn execute(
        lhs: &StageReader<MP::ES, TL>,
        rhs: &StageReader<MP::ES, TR>,
