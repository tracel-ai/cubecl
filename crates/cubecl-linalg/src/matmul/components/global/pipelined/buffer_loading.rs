...
use crate::matmul::components::global::{pipelined, Config as _};
...
impl BufferLoading {
    pub fn load_to_slice<EG: Numeric, ES: Numeric, S: stage::Config>(
        ...
        for i in 0..num_loads_per_unit {
            ...
            let line_read = read_view.load_coalesced::<pipelined::Config<S>>(
                tile_x,
                tile_y,
                pos_within_tile,
                ident,
...
fn unsupported_transpose_load() {
    panic!("Transpose load not yet supported in pipelined setup")
}
