...
pub struct SimpleBarrierCoopMatmulFamily<
...
impl<SMM, LL, RL> GlobalMatmulFamily for SimpleBarrierCoopMatmulFamily<SMM, LL, RL>
where
    SMM: stage::StageMatmulFamily<LhsReader = LhsReaderFamily, RhsReader = RhsReaderFamily>,
    LL: AsyncLoadingStrategy,
    RL: AsyncLoadingStrategy,
{
    type Matmul<MP: MatmulPrecision> = SimpleBarrierCoopMatmul<
        MP,
...
impl<SMM, LL, RL> MatmulConfigFactory for SimpleBarrierCoopMatmulFamily<SMM, LL, RL>
where
    SMM: stage::StageMatmulFamily,
    LL: AsyncLoadingStrategy,
    RL: AsyncLoadingStrategy,
...
pub struct SimpleBarrierCoopMatmul<
    MP: MatmulPrecision,
...
#[cube]
impl<MP: MatmulPrecision, SMM, LL, RL> GlobalMatmul<MP> for SimpleBarrierCoopMatmul<MP, SMM, LL, RL>
where
    SMM: StageMatmul<
        MP::ES,
        MP::EG,
    ...
    RL: AsyncLoadingStrategy,
{
    ...
    fn execute(
        ...
        let barrier = Barrier::<MP::ES>::new(BarrierLevel::cooperative());
