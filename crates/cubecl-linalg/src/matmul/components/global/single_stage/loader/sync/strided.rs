...
use crate::matmul::components::stage::{StridedTilingLayout, TilingOrder};
...
pub struct StridedCoalescedLoading<T: TilingOrder> {
    tiling_order: PhantomData<T>,
}

impl<T: TilingOrder> LoadingValidation for StridedCoalescedLoading<T> {
...
#[cube]
impl<T: TilingOrder> SyncLoadingStrategy for StridedCoalescedLoading<T> {
    ...
    fn load<EG: Numeric, ES: Numeric, G: GlobalConfig>(
        ...
        for i in 0..num_loads_per_unit {
            ...
            let line_read = read_view.load_coalesced_in_stage(unit_position, ident, config);
