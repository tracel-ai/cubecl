...
use crate::matmul::components::global::single_stage::CooperativeWindowLoading;
use crate::matmul::components::stage::{self};
use crate::matmul::components::MatmulProblem;
use crate::matmul::components::{batch, global};
use crate::matmul::components::{tile, MatmulSelection};

pub struct SimpleBarrierStridedAlgorithm<TMM, Dispatch = batch::TransposedDispatch> {
    pub _tmm: PhantomData<TMM>,
    pub _dispatch: PhantomData<Dispatch>,
}

impl<TMM, Dispatch> base::Algorithm for SimpleBarrierStridedAlgorithm<TMM, Dispatch>
where
