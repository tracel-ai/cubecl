...
pub struct SimpleBarrierAlgorithm<TMM, L, Dispatch = batch::TransposedDispatch> {
    ...
    L: AsyncLoadingStrategy,
{
    ...
    type GlobalMatmul =
        global::single_stage::simple::SimpleBarrierDummyMatmulFamily<Self::StageMatmul, L, L>;
