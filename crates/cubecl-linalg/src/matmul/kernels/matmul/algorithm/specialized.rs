...
use crate::matmul::components::global::loader::SyncBufferCyclicLoading;
    ...
    Dispatch: CubeDispatch + CubeCountDispatch,
{
    ...
    type GlobalMatmul = global::multi_stage::specialized::SpecializedMatmulFamily<
        Self::StageMatmul,
        SyncBufferCyclicLoading<ColMajorTilingOrder>,
        SyncBufferCyclicLoading<RowMajorTilingOrder>,
    >;
