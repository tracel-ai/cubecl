...
macro_rules! matmul_tma_tests {
    () => {
        ...
        mod row_major {
            ...
            mod row_major {
                use super::*;
                $crate::matmul_tma_tests!(RowMajor, RowMajor);
            }

            mod col_major {
                use super::*;
                $crate::matmul_tma_tests!(RowMajor, ColMajor);
            }
        }
        ...
        mod col_major {
            ...
            mod row_major {
                use super::*;
                $crate::matmul_tma_tests!(ColMajor, RowMajor);
            }

            mod col_major {
                use super::*;
                $crate::matmul_tma_tests!(ColMajor, ColMajor);
            }
        }
    };
    ...
    ($lhs_layout:ident, $rhs_layout:ident) => {
        ...
        mod t32x8x16 {
            use super::*;
            $crate::matmul_tma_tests!($lhs_layout, $rhs_layout, MatmulSize { m: 32, n: 8, k: 16 });
        }

        mod t8x32x16 {
            use super::*;
            $crate::matmul_tma_tests!($lhs_layout, $rhs_layout, MatmulSize { m: 8, n: 32, k: 16 });
        }

        mod t16x16x8 {
            use super::*;
            $crate::matmul_tma_tests!($lhs_layout, $rhs_layout, MatmulSize { m: 16, n: 16, k: 8 });
        }
    };
