...
macro_rules! matmul_test_define {
    (
        ...
        pub fn bo4_gbp256x256x256_s4x4x2_t16x16x16_rr_ln4() {
            ...
            type GA = global::args::TensorArgs;
            type EG = $eg;

            impl matmul::Algorithm<GA, $eg> for Test {
                ...
                type StageMatmul =
                    stage::single_buffer::Matmul<Self::ES, EG, Self::EA, Self::TileMatmul, S4x4x2>;
                type GlobalMatmul =
                    global::buffered::pipelined::Matmul<EG, Self::ES, Self::EA, Self::StageMatmul>;
        ...
        pub fn bo1_gbp16x16x256_s1x1x2_t16x16x16_rr_ln4() {
            ...
            impl matmul::Algorithm<GA, $eg> for Test {
                ...
                type TileMatmul = $t_16x16x16<Self::ES, Self::EA>;
                type StageMatmul =
                    stage::single_buffer::Matmul<Self::ES, EG, Self::EA, Self::TileMatmul, S1x1x2>;
                type GlobalMatmul =
                    global::buffered::pipelined::Matmul<EG, Self::ES, Self::EA, Self::StageMatmul>;
                type BatchMatmul = batch::one_to_one::Matmul<
                    GA,
