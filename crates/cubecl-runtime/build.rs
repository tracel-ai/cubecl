...
fn main() {
    ...
    cfg_aliases! {
        ...
        autotune_persistence: { any(all(feature = "std", any(target_os = "windows", target_os = "linux", target_os = "macos", target_os = "android")), all(target_family = "wasm", feature = "browser-cache")) },
