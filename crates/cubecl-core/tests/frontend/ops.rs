...
mod tests {
    ...
    macro_rules! binary_test {
        ($test_name:ident, $op_expand:expr, $op_name:expr, $func:ident) => {
            ...
            fn $test_name() {
                ...
                let x = context.create_local_mut(Item::new(Elem::Float(FloatKind::F32)));
                let y = context.create_local_mut(Item::new(Elem::Float(FloatKind::F32)));
    ...
    macro_rules! binary_boolean_test {
        ($test_name:ident, $op_expand:expr, $op_name:expr) => {
            ...
            fn $test_name() {
                let mut context = CubeContext::default();
                let x = context.create_local_mut(Item::new(Elem::Bool));
                let y = context.create_local_mut(Item::new(Elem::Bool));
    ...
    macro_rules! binary_u32_test {
        ($test_name:ident, $op_expand:expr, $op_name:expr) => {
            ...
            fn $test_name() {
                let mut context = CubeContext::default();
                let x = context.create_local_mut(Item::new(u32::as_elem()));
                let y = context.create_local_mut(Item::new(u32::as_elem()));
