...
mod tests {
    ...
    fn test_function_generic() {
        ...
        let lhs = context.create_variable(Item::new(f32::as_elem()));
        let rhs = context.create_variable(Item::new(f32::as_elem()));
    ...
    fn simple_scope() -> Scope {
        ...
        let lhs = context_ref.create_variable(Item::new(f32::as_elem()));
        let rhs = context_ref.create_variable(Item::new(f32::as_elem()));
