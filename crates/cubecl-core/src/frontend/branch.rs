...
impl<I: Int> Iterable<I> for RangeExpand<I> {
    ...
    fn expand(
        ...
        let i = child.create_variable_restricted(index_ty);
...
pub fn if_else_expr_expand<C: CubePrimitive>(
    ...
    match comptime_cond {
        ...
        None => {
            ...
            let out: ExpandElementTyped<C> = context.create_variable_mut(ret.expand.item).into();
...
pub fn switch_expand_expr<I: Int, C: CubePrimitive>(
    ...
    let out: ExpandElementTyped<C> = context.create_variable_mut(default.expand.item).into();
