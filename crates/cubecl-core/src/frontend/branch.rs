    ...
    pub fn or_else(
        ...
        match self {
            Self::Runtime {
                ...
                assign::expand_init::<C>(&mut else_child, ret, out.clone());
...
pub fn if_else_expr_expand<C: CubePrimitive>(
    ...
    match comptime_cond {
        ...
        None => {
            ...
            assign::expand_init::<C>(&mut then_child, ret, out.clone());
...
impl<I: Int, C: CubePrimitive> SwitchExpandExpr<I, C> {
    pub fn case(
        ...
        assign::expand_init::<C>(&mut case_child, ret, self.out.clone());
        self.cases.push((value.into(), case_child));
        self
    }
...
pub fn switch_expand_expr<I: Int, C: CubePrimitive>(
    ...
    assign::expand_init::<C>(&mut default_child, default, out.clone());
