...
impl tf32 {
    ...
    /// let bytes = tf32::from_f32(12.5).to_le_bytes();
    /// assert_eq!(bytes, [0, 0, 0x48, 0x41]);
    /// ```
    #[inline]
    #[must_use]
    ...
    /// ```rust
    /// # use cubecl_core::prelude::*;
    /// let bytes = tf32::from_f32(12.5).to_be_bytes();
    /// assert_eq!(bytes, [0, 0, 0x41, 0x48]);
    /// ```
    #[inline]
    #[must_use]
    ...
    /// ```rust
    /// # use cubecl_core::prelude::*;
    /// let bytes = tf32::from_f32(12.5).to_ne_bytes();
    ...
    /// ```rust
    /// # use cubecl_core::prelude::*;
    /// let value = tf32::from_le_bytes([0, 0, 0x48, 0x41]);
    /// assert_eq!(value, tf32::from_f32(12.5));
    /// ```
    #[inline]
    #[must_use]
    pub const fn from_le_bytes(bytes: [u8; 4]) -> tf32 {
        tf32::from_bits(u32::from_le_bytes(bytes))
    }
    ...
    /// ```rust
    /// # use cubecl_core::prelude::*;
    /// let value = tf32::from_be_bytes([0, 0, 0x41, 0x48]);
    /// assert_eq!(value, tf32::from_f32(12.5));
    /// ```
    #[inline]
    #[must_use]
    pub const fn from_be_bytes(bytes: [u8; 4]) -> tf32 {
        tf32::from_bits(u32::from_be_bytes(bytes))
    }
    ...
    /// ```rust
    /// # use cubecl_core::prelude::*;
    /// let value = tf32::from_ne_bytes(if cfg!(target_endian = "big") {
    ///     [0, 0, 0x41, 0x48]
    /// } else {
    ///     [0, 0, 0x48, 0x41]
    /// });
    ...
    #[inline]
    #[must_use]
    pub const fn from_ne_bytes(bytes: [u8; 4]) -> tf32 {
        tf32::from_bits(u32::from_ne_bytes(bytes))
    }
