    ...
    F: Fn(BinaryOperator) -> Operator,
{
    ...
    let output = context.create_variable(item);
    let out = *output;
    ...
    F: Fn(BinaryOperator) -> Operator,
{
    ...
    let out = context.create_variable(out_item);
    ...
    F: Fn(UnaryOperator) -> Operator,
{
    ...
    let out = context.create_variable(item);
    let out_var = *out;
...
{
    let input = input.consume();
    let output = context.create_variable_mut(out_item);
    let out = *output;
    ...
    F: Fn(Variable) -> Operation,
{
    ...
    let out = context.create_variable_mut(item);
    let out_var = *out;
    ...
    A::Output: CubeType + Sized,
{
    ...
    let op_out = context.create_variable(array.item);
