...
fn assert_complex_validation_error(result: Result<(), ServerError>, expected_fragment: &str) {
    match result {
        Err(error) => assert!(
            format!("{error:?}").contains(expected_fragment),
            "Expected validation error containing `{expected_fragment}`, got: {error:?}",
        ),
...
pub fn kernel_complex_add<C: ComplexCore>(output: &mut [C], lhs: &[C], rhs: &[C]) {
...
#[cube(launch_unchecked)]
pub fn kernel_complex_sub<C: ComplexCore>(output: &mut [C], lhs: &[C], rhs: &[C]) {
    if ABSOLUTE_POS < output.len() {
        output[ABSOLUTE_POS] = lhs[ABSOLUTE_POS] - rhs[ABSOLUTE_POS];
    }
}
...
#[cube(launch_unchecked)]
pub fn kernel_complex_mul<C: ComplexCore>(output: &mut [C], lhs: &[C], rhs: &[C]) {
    if ABSOLUTE_POS < output.len() {
        output[ABSOLUTE_POS] = lhs[ABSOLUTE_POS] * rhs[ABSOLUTE_POS];
    }
}
...
#[cube(launch_unchecked)]
pub fn kernel_complex_div<C: ComplexCore>(output: &mut [C], lhs: &[C], rhs: &[C]) {
    if ABSOLUTE_POS < output.len() {
        output[ABSOLUTE_POS] = lhs[ABSOLUTE_POS] / rhs[ABSOLUTE_POS];
    }
}
...
#[cube(launch_unchecked)]
pub fn kernel_complex_neg<C: ComplexCore>(output: &mut [C], input: &[C]) {
    if ABSOLUTE_POS < output.len() {
...
#[cube(launch_unchecked)]
pub fn kernel_complex_conj<C: ComplexCore>(output: &mut [C], input: &[C]) {
    if ABSOLUTE_POS < output.len() {
...
#[cube(launch_unchecked)]
pub fn kernel_complex_real_cf32(output: &mut [f32], input: &[num_complex::Complex<f32>]) {
    if ABSOLUTE_POS < output.len() {
...
#[cube(launch_unchecked)]
pub fn kernel_complex_real_cf64(output: &mut [f64], input: &[num_complex::Complex<f64>]) {
    if ABSOLUTE_POS < output.len() {
        output[ABSOLUTE_POS] = input[ABSOLUTE_POS].real_val();
    }
}
...
#[cube(launch_unchecked)]
pub fn kernel_complex_imag_cf32(output: &mut [f32], input: &[num_complex::Complex<f32>]) {
    if ABSOLUTE_POS < output.len() {
...
#[cube(launch_unchecked)]
pub fn kernel_complex_imag_cf64(output: &mut [f64], input: &[num_complex::Complex<f64>]) {
    if ABSOLUTE_POS < output.len() {
        output[ABSOLUTE_POS] = input[ABSOLUTE_POS].imag_val();
    }
}
...
#[cube(launch_unchecked)]
pub fn kernel_complex_constant<C: ComplexCore + cubecl::ScalarArgType + LaunchArg>(
    output: &mut [C],
    scale: C,
) {
    if ABSOLUTE_POS < output.len() {
        ...
        pub fn $test_name<R: Runtime>(client: ComputeClient<R>) {
            ...
            unsafe {
                $kernel::launch_unchecked::<C, R>(
                    ...
                    BufferArg::from_raw_parts(handle_output.clone(), lhs.len()),
                    BufferArg::from_raw_parts(handle_lhs, lhs.len()),
                    BufferArg::from_raw_parts(handle_rhs, rhs.len()),
                )
            };
        ...
        pub fn $test_name<R: Runtime>(client: ComputeClient<R>) {
            ...
            unsafe {
                $kernel::launch_unchecked::<C, R>(
                    ...
                    BufferArg::from_raw_parts(handle_output.clone(), input.len()),
                    BufferArg::from_raw_parts(handle_input, input.len()),
                )
            };
...
#[cube(launch_unchecked)]
pub fn kernel_complex_abs_cf32(output: &mut [f32], input: &[num_complex::Complex<f32>]) {
    if ABSOLUTE_POS < output.len() {
...
#[cube(launch_unchecked)]
pub fn kernel_complex_norm_cf64(output: &mut [f64], input: &[num_complex::Complex<f64>]) {
    if ABSOLUTE_POS < output.len() {
        output[ABSOLUTE_POS] = input[ABSOLUTE_POS].norm();
    }
}

#[cube(launch_unchecked)]
pub fn kernel_complex_exp<C: ComplexMath + Exp>(output: &mut [C], input: &[C]) {
    if ABSOLUTE_POS < output.len() {
...
#[cube(launch_unchecked)]
pub fn kernel_complex_log<C: ComplexMath + Log>(output: &mut [C], input: &[C]) {
    if ABSOLUTE_POS < output.len() {
...
#[cube(launch_unchecked)]
pub fn kernel_complex_sin<C: ComplexMath + Sin>(output: &mut [C], input: &[C]) {
    if ABSOLUTE_POS < output.len() {
...
#[cube(launch_unchecked)]
pub fn kernel_complex_cos<C: ComplexMath + Cos>(output: &mut [C], input: &[C]) {
    if ABSOLUTE_POS < output.len() {
...
#[cube(launch_unchecked)]
pub fn kernel_complex_sqrt<C: ComplexMath + Sqrt>(output: &mut [C], input: &[C]) {
    if ABSOLUTE_POS < output.len() {
...
#[cube(launch_unchecked)]
pub fn kernel_complex_tanh<C: ComplexMath + Tanh>(output: &mut [C], input: &[C]) {
    if ABSOLUTE_POS < output.len() {
...
#[cube(launch_unchecked)]
pub fn kernel_complex_powf<C: ComplexMath + Powf>(output: &mut [C], lhs: &[C], rhs: &[C]) {
    if ABSOLUTE_POS < output.len() {
...
pub fn test_complex_abs_cf32<R: Runtime>(client: ComputeClient<R>) {
    ...
    unsafe {
        kernel_complex_abs_cf32::launch_unchecked::<R>(
            ...
            CubeCount::new_single(),
            CubeDim::new_1d(2),
            BufferArg::from_raw_parts(handle_output.clone(), 2),
            BufferArg::from_raw_parts(handle_input, 2),
        )
    };
...
#[cube(launch)]
pub fn kernel_complex_validation_core<C: ComplexCore>(output: &mut [C], lhs: &[C], rhs: &[C]) {
    if UNIT_POS == 0 {
...
#[cube(launch)]
pub fn kernel_complex_validation_math<C: ComplexMath>(output: &mut [C], input: &[C]) {
    if UNIT_POS == 0 {
...
pub fn test_complex_validation_core<R: Runtime>(client: ComputeClient<R>) {
    ...
    kernel_complex_validation_core::launch::<C, R>(
        ...
        unsafe { BufferArg::from_raw_parts(lhs, 1) },
        unsafe { BufferArg::from_raw_parts(rhs, 1) },
    );
...
pub fn test_complex_validation_math<R: Runtime>(client: ComputeClient<R>) {
    ...
    kernel_complex_validation_math::launch::<C, R>(
        ...
        CubeDim::new_1d(1),
        unsafe { BufferArg::from_raw_parts(output.clone(), 1) },
        unsafe { BufferArg::from_raw_parts(input, 1) },
    );
...
macro_rules! testgen_complex_math {
    () => {
        ...
        mod complex_math {
            ...
            #[$crate::runtime_tests::test_log::test]
            fn test_complex_norm_cf64() {
                let client = TestRuntime::client(&Default::default());
                cubecl_core::runtime_tests::complex::test_complex_norm_cf64::<TestRuntime>(client);
            }
