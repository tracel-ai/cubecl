...
You can activate the feature `pliron-dump` and set the environment variable `CUBECL_DEBUG_PLIRON={directory}` to have all shaders, along with the pliron IR after every pass, saved in that directory.
