...
// /// Uses cmma but without knowledge of each data is
// /// possessed by which unit, hence we have to use shared memory
// ///
// /// The shared memory is inserted as an extra step between
// /// score matmul result and value matmul lhs
// pub struct AcceleratedBlackBoxFragmentAttention;
...
// #[cube]
// impl FragmentLayout for SmemLayout {
...
//     type Layout = SmemLayout;

//     fn rowwise_max(&self) -> RowWise<E> {
//         // Write in shared memory
//         // Compute max for every row
//     }
...
// #[cube]
// impl<AP: AttentionPrecision> FragmentAttention<AP> for AcceleratedBlackBoxFragmentAttention {
...
//     type FragmentLayout = SmemLayout;
