...
/// window needs must therefore be served by the pages warmed before it. The server refuses to
/// allocate while recording, so a memory node here means something went around it.
///
/// # Safety
///
