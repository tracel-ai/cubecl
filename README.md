...
It's easy to add more, and we intend to support many; contributions are welcome!

- [X] CUDA
- [X] WebGPU
- [ ] Metal (though WebGPU natively compiles to Metal)
- [ ] ROCm
- [ ] Vulkan (though WebGPU natively compiles to Vulkan) 
